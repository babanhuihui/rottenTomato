...
//  rottenTomato
//
//  Created by Shuhui Qu on 4/13/15.
//  Copyright (c) 2015 Shuhui Qu. All rights reserved.
//

import UIKit

class DVDViewController: UIViewController, UITableViewDelegate,UITableViewDataSource, UISearchBarDelegate{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var url = NSURL(string: "http://api.rottentomatoes.com/api/public/v1.0/lists/dvds/top_rentals.json?apikey=jkrcmcm42ds9aymcm6ehfw9z")!
